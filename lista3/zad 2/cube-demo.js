...
var createTexture2D= function(gl, skyboxStep, id){
    /* parameters:
       gl -  WebGL contex
...
function onKeyDown(e){
    ...
    case 81: // Q
        ...
        for(var skyboxStep=0; skyboxStep<6; skyboxStep++ ){
            boxFaceTextures[skyboxStep] = createTexture2D(gl, skyboxStep, i);
        }
        i++;
    break;
      /*case 77: // M
...
window.onload= function(){
    ...
    for(var skyboxStep=0; skyboxStep<6; skyboxStep++ ){
    sbx_fillCanvasUpsideDown( canvasTex, document.getElementById("background"));
    sbx_loadCubeFaceFromCanvas(gl, canvasTex, cubeFace[skyboxStep]);
    boxFaceTextures.push( createTexture2D(gl, skyboxStep, 0) );
    }
